$(document).ready(function(){
   ...
   //get all data
    function getAllData(){
        $.ajax({
            url: "../partials/ajax.php?report=itemReportAll",
            method: "get",
            success: function(data){
                ...
                if(data != "1"){
                    for(let row in inv){
                        ...
                        <td>${inv[row]['sub_category']}</td>
                        <td>${inv[row]['quantity']}</td>
                    </tr>`;
                    }
    ...
    $("#search").keyup(function(e){
        if($("#search").val() == ""){
            ...
            $.ajax({
                url:"../partials/ajax.php?get=searchItemReport&keyword="+ $("#search").val(),
                method:"get",
                success:function(data){
